...
from .modeling.transformer_decoder.tsclip_transformer_decoder import MaskPooling, get_classification_logits
VILD_PROMPT = [
    "a photo of a {}.",
...
class FCCLIP(nn.Module):
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            "criterion": criterion,
            "num_queries": cfg.MODEL.TSCLIP.QUERY_H * cfg.MODEL.TSCLIP.QUERY_W,
            ...
            "probability_swap_thing": cfg.MODEL.TSCLIP.PROBABILITY_SWAP_THING,
            "probability_swap_stuff": cfg.MODEL.TSCLIP.PROBABILITY_SWAP_STUFF,
        }
