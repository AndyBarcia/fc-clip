...
from ..transformer_decoder.tsclip_transformer_decoder import build_transformer_decoder
...
class FCCLIPHead(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        return {
            ...
            "use_rd": cfg.MODEL.TSCLIP.USE_RELATIONSHIP_DESCRIPTOR,
            ...
            "thing_stuff_adapter": cfg.MODEL.TSCLIP.THING_STUFF_ADAPTER_TYPE,
        }
