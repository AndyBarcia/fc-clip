...
from .tsclip_transformer_decoder import (
...
class MultiScaleExtendedMaskedTransformerDecoder(nn.Module):
    ...
    def from_config(cls, cfg, in_channels, mask_classification):
        ...
        ret["query_h"] = cfg.MODEL.TSCLIP.QUERY_H
        ret["query_w"] = cfg.MODEL.TSCLIP.QUERY_W
        ret["query_init_type"] = cfg.MODEL.TSCLIP.QUERY_INIT_TYPE
        ret["query_pos_init_type"] = cfg.MODEL.TSCLIP.QUERY_POS_INIT_TYPE
        ...
        ret["text_attn"] = cfg.MODEL.TSCLIP.TEXT_ATTN
        ret["text_atnn_cls"] = cfg.MODEL.TSCLIP.TEXT_ATTN_CLS
        ret["mask_dim"] = cfg.MODEL.SEM_SEG_HEAD.MASK_DIM
        ret["clip_embedding_dim"] = cfg.MODEL.FC_CLIP.EMBED_DIM
        ret["mask_embed_type"] = cfg.MODEL.TSCLIP.MASK_EMBED_TYPE
        ret["class_embed_type"] = cfg.MODEL.TSCLIP.CLASS_EMBED_TYPE
        ret["attn_conv_kernel_size"] = cfg.MODEL.TSCLIP.ATTN_CONV_KERNEL_SIZE
        ret["box_reg_type"] = cfg.MODEL.TSCLIP.BOX_REGRESSION_TYPE
        ret["cross_attn_type"] = cfg.MODEL.TSCLIP.CROSS_ATTN_TYPE
        ret["self_attn_type"] = cfg.MODEL.TSCLIP.SELF_ATTN_TYPE
        ret["mask_pos_mlp_type"] = cfg.MODEL.TSCLIP.MASK_POS_MLP_TYPE
        ret["separate_thing_stuff_mask_embed"] = cfg.MODEL.TSCLIP.SEPARATE_THING_STUFF_MASK_EMBED
        return ret
