...
def get_ade20k_610_categories_with_prompt_eng():
    ...
    assert len(prompt_names) == len(ADE20K_610_OLD_TRAIN_IDS), (len(prompt_names), len(ADE20K_610_OLD_TRAIN_IDS))

    for new_train_id, old_train_id in enumerate(ADE20K_610_OLD_TRAIN_IDS):
        ...
        ADE20K_610_CATEGORIES_.append(cat)

    return ADE20K_610_CATEGORIES_




def get_ade20k_610_superclass_merged_equiv_categories_with_prompt_eng():
    return get_ade20k_610_categories_with_prompt_eng()
